        ...
        for beginyear in [1988, 2011, 2014]:
            for actype in range(1,4):
                for interval in [3,6,12,36]:
                    ...
                    final, datelist = core.getfreqlist([beginyear,2015], interval, a, 2) # looking for cancellatino frequency
                    ...
                    filename = "CancTop%d_ata%d_ac%d_%d-2015_interv%d" % (top, atalevel, actype, beginyear, interval)
